...
#evaluate predictions
    ...
    xgbMetrics=calculateMMetrics(y_true=sub_test$resid,
...
for (i_test in 1:nsplit) {
  ...
  xgb_Roberts1 <- do.call(c, cpred)
  all_predict_xgb1 = cbind(predict_xgb1 = xgb_Roberts1, dplyr::select(sub_test, c(x,y,time)))
  save(all_predict_xgb1, file = paste0("all_predict_xgb1_", current_year, "_", i_test, ".RData"))
