...
#HERE CHANGE
path_to="/bettik/barbalag/calculate_metrics/"
...
load(paste0(path_to,"holdout_folds_STBlMo_5F_",current_year,".RData"))
...
load(file=paste0(path_to,"all_predict_ens_folds",current_year,".RData"))
...
for (idx_fold in 1:nfolds) {
  ...
  y_true=c(y_true,ens_DB_test$day_mean)
